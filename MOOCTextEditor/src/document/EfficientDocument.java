...
public class EfficientDocument extends Document {
	...
	private void processText()
	{
		...
		numWords=0;  // The number of words in the document
		numSentences=0;  // The number of sentences in the document
		numSyllables=0;  // The number of syllables in the document
		
		//This line will give a list of continuous punctuation or continuous letters
		...
		//include last sentence even if no punctuation
		//first evaluates if list is empty to avoid exception
