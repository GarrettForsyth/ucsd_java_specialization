...
public class BasicDocument extends Document 
{
	...
	public int getNumSyllables()
	{
		...
		//count syllables in each word of list containing all words from text
		for(String word : words){
			sylCount+= super.countSyllables(word);
		}
        return sylCount;
	}
	...
	public static void main(String[] args)
	{
		...
		BasicDocument test= new BasicDocument("There is hereby imposed on the taxable income of every individual (other than a surviving spouse as defined in section 2(a) or the thead of a household as defined in section 2(b)) who is not a married individual (as defined in section 7703) a tax determined in accordance with the following table:");
		BasicDocument test2= new BasicDocument("If you are single, never lost your spouse, and not the head of a household, you pay taxes according to the following table:");
		System.out.println(test.getFleschScore());
		System.out.println(test2.getFleschScore());
	}
