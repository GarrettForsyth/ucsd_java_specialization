...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
		...
		//Print Headings
		System.out.println("NumberOf Chars BasicTime EfficientTime");
				...
				numToCheck += increment)
		{
			...
			String run= getStringFromFile(textfile, numToCheck);
			
			long startTimer= System.nanoTime();
			for(int i=0; i < trials; i++){
				BasicDocument testBasicDoc= new BasicDocument(run);
			...
			for(int i=0; i < trials; i++){
				EfficientDocument testEfficientDoc= new EfficientDocument(run);
