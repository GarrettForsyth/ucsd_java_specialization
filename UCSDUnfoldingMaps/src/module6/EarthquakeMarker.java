...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	public int compareTo(EarthquakeMarker quakeMarker){
		Float obj1= (Float) this.getMagnitude();
		Float obj2= (Float) quakeMarker.getMagnitude();
		//multiply by -1 to sort for highest to lowest
